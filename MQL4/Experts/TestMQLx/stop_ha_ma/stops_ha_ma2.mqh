...
input double stop_loss1 = 250;
input double take_profit1 = 250;
input ENUM_STOP_TYPE stop_type1 = STOP_TYPE_PENDING; 

input double stop_loss2 = 350;
input double take_profit2 = 350;
input ENUM_STOP_TYPE stop_type2 = STOP_TYPE_VIRTUAL; 
   ...
   for(int i=orders.Total()-1;i>=0;i--)
     {
      ...
      if(!CheckPointer(order))
         continue;
      //Print(order.Ticket()+" "+orders.Total());
      order.OnTick();
