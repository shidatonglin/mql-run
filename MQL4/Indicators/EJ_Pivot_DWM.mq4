...
ObjectSetText("P label", "                         Pivot  " +DoubleToStr(P,4), 10, "Arial",
Coral);
}
else
{
...
ObjectSetText("S1 label", " S1", 8, "Arial", DodgerBlue);
}
else
{
...
ObjectSetText("S2 label", " S2", 8, "Arial", DodgerBlue);
}
else
{
...
ObjectSetText("S3 label", " S3", 8, "Arial", DodgerBlue);
}
else
{
...
ObjectSet("S1 line", OBJPROP_COLOR, DodgerBlue);
}
else
{
...
ObjectSet("S3 line", OBJPROP_COLOR, DodgerBlue);
}
else
{
...
ObjectSet("P line", OBJPROP_COLOR, Coral);
}
else
{
